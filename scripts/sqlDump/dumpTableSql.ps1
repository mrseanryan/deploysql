...
#
#ref: http://msdn.microsoft.com/en-us/library/microsoft.sqlserver.management.smo.scriptingoptions.aspx#Y240
#
...
$scrp.Options.IncludeHeaders = $False #we do NOT want date/time as that would mean all scripts always have changes
