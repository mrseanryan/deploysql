...
class StoredProcedureFactory(DatabaseObjectFactoryBase):
	...
	def __init__(self):
		...
		#TODO -SP dump seems to cause very long lines to wrap.  not sure if this is behaviour of sp_help OR our clean processing.  example: dbo.spLoader_IsTypeSigned.StoredProcedure.sql
